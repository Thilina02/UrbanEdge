...
const Footer = () => {
    ...
    <StyledFooter>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          <StyledContactInfo>
            <EmailIcon />
            <Typography>info@urbanedge.lk</Typography>
          </StyledContactInfo>
          <StyledContactInfo>
            <LocationOnIcon />
  ...
  <div className="Description">𝓕𝓸𝓵𝓵𝓸𝔀 𝓾𝓼 𝓱𝓮𝓻𝓮!!</div>

  <div className="social-media" style={{height:'2vh'}}>
        ...
        <a href="https://www.linkedin.com/in/thilina-perera-8ba24825b/">
            <svg viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
